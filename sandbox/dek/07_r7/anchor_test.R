...
#'
#' @author Dan Kelley
anchor_test <- function(model = "1 Railway Wheel", buoyancy = NULL, height = NULL, CD = NULL, depth = 0) {
    ...
    anchor(model = model, buoyancy = buoyancy, height = height, area = 0, CD = CD, waterDepth = depth, source = source, originalName = originalName)
} # anchor()
