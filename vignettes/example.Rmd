...
plot(mdk, "knockdown", xlim=c(0,30), showDetails=TRUE)
plot(mdk, "velocity")
```
...
```{r fig.cap="**Speed-knockdown summary diagram**", fig.width=7, fig.height=4, out.width="100%", fig.align="center", dev.args=list(pointsize=10)}
...
plot(mdkDraggy, "knockdown", xlim=c(0, 30), showDetails=TRUE)
