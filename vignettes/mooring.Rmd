...
The dashed horizontal line shows zero knockdown, while the dotted line
indicates a 10 percent knockdown.  If the latter is taken as a limit, this
suggests that more buoyant float would be required in this region if currents
exceeded approximately $0.3$m/s.
