...
## ---- fig.cap="**Simulation of knockdown with a depth-decaying current.**", fig.height=4, fig.width=7, fig.align="center", out.width="100%", dev.args=list(pointsize=10)----
...
## ---- echo=FALSE, fig.cap="**Simulation with doubled wire drag.**", fig.height=4, fig.width=7, fig.align="center", out.width="100%", dev.args=list(pointsize=10)----
m <- mooring(anchor(depth=1400),
             chain("5/8in galvanized chain", length=10),
             release("benthos 965a release"),  # dual benthos 965-a
             BUB3,
