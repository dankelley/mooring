...
* A measure of buoyancy force divided by $g$, the acceleration due to gravity.
  For a solid object, this is a simple number, expressed in kg, and denoted $m$
  below. For a cable, it is expressed per unit length of cable, i.e. in kg/m,
  and denoted $\mu$ below.  Manufacturers tend to provide $m$ or $\mu$ in
  technical documentation about mooring components.
