...
1. 2021-06-08 (thanks to @formulafunracing and @clayton33 for advice on this)
   1. Move discrete chain items like shackles to a new entity, "connector".
      Those objects will have `height` and `width`.
...
```{r}
knitr::kable(read.csv("connectors_bio.csv"))
```
...
colC <- c(0.74,0.563,1,0.563,1.187,1,1,1.286,1.286,1.286,1.286,2.42,2.42)
colG <- c(0.22,0.22,0.22,0.22,0.466,0.44,0.65,1.822,1.822,1.807,1.822,0.51,0.51)
area <- colG*colC
round(area, 3)
